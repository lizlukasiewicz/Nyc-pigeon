      ...
      <main className="flex flex-col items-center w-full flex-1 md:px-20 text-center ">
        <div className="md:w-5/6 md:grid grid-cols-2 gap-1 space-y-6">
          ...
          <div className="bg-palette-1 md:h-96 md:overflow-y-auto"><h1 className="md:text-lg font-medium text-blue hover:text-purple"><a href="https://capstone-nine.vercel.app/" target="_blank">Riders Guild</a></h1>
              ...
              <p className="text-blue text-sm text-left">A Blog built with NextAuth for user authentication and database encryption, RESTful API functionality for posts and comments between users.<br></br> 
          ...
          <div className=" bg-palette-4 md:h-96 md:overflow-y-auto" id="falendar">
            ...
            <p className="text-sm text-primary text-right">The goal was to make a stripped down calendar which is easy to read at a glance. Regular events 
          ...
          <div className="bg-palette-3 md:h-96 md:overflow-y-auto">
            ...
            <p className="text-primary text-sm text-left">Full stack Express and Postgres app that uses Sequelize as an ORM to interact with protected 
            ...
            <h1 className="md:text-lg font-medium text-blue hover:text-purple"><a href="https://lizlukasiewicz.github.io/Project-1-escape-Noface/" target="_blank">Escape Noface</a></h1>
            ...
            <p className="text-sm text-blue text-right">Sucess! NoFace has eaten the medicine you got from the River Spirit, But now he's projectile vomiting 
